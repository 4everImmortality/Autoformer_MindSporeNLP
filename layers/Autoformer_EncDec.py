...
class my_Layernorm(nn.Cell):
    ...
    def construct(self, x):
        ...
        bias = ops.ReduceMean(keep_dims=True)(x_hat, 1)
        return x_hat - bias
...
class moving_avg(nn.Cell):
    ...
    def __init__(self, kernel_size, stride):
        ...
        self.avg = nn.AvgPool1d(kernel_size=kernel_size, stride=stride, pad_mode='pad')
...
class DecoderLayer(nn.Cell):
    ...
    def __init__(self, self_attention, cross_attention, d_model, c_out, d_ff=None,
        ...
        self.dropout = nn.Dropout(1 - dropout)
        self.projection = nn.Conv1d(in_channels=d_model, out_channels=c_out, kernel_size=3, stride=1, pad_mode='pad')
        self.activation = nn.ReLU() if activation == "relu" else nn.GELU()
    ...
    def construct(self, x, cross, x_mask=None, cross_mask=None):
        ...
        residual_trend = self.projection(residual_trend.transpose(0, 2, 1)).transpose(1, 2)
